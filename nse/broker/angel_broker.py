...
class AngelBroker:
    ...
    def _build_order_payload(self, leg: ComboLeg, variety: str = "NORMAL") -> dict:
        ...
        return {
            ...
            "duration": "DAY",
            "quantity": leg.lots * LOT_SIZES.get(self._symbol_from_ts(leg.tradingsymbol), 1),
            "price": "0",
            "squareoff": "0",
            "stoploss": "0",
            "triggerprice": "0",
    ...
    def place_single_order(self, symbol: str, tradingsymbol: str, token: str,
        ...
        payload = {
            ...
            "producttype": PRODUCT_TYPE,
            "duration": "DAY",
            "quantity": lots * LOT_SIZES.get(symbol, 1),
            "price": "0",
            "squareoff": "0",
            "stoploss": "0",
            "triggerprice": "0",
        ...
        for leg in position.legs:
            try:
                ...
                payload = {
                    ...
                    "producttype": PRODUCT_TYPE,
                    "duration": "DAY",
                    "quantity": leg.lots * LOT_SIZES.get(position.symbol, 1),
                    "price": "0",
                    "squareoff": "0",
                    "stoploss": "0",
                    "triggerprice": "0",
