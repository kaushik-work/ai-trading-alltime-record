        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={fetchDebug}
              disabled={loading}
              className="flex items-center gap-2 text-sm font-semibold px-4 py-2 border border-gray-300 rounded-lg bg-white hover:border-gray-400 transition-colors disabled:opacity-50"
            >
              {loading ? (
